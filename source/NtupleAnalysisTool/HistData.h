...
class HistData
{
  public :
    ...
    void HistInit()
    {
      // ===== fill in 2muinBarrel =====
      //dR check
      m_h_OffdR = new TH1D("m_h_OffdR", "Offline extdR;#DeltaR;events", 80, 0, 0.4);
      ...
      m_h_n_passedRatio_exclusive = new TH1D("m_h_n_passedRatio_exclusive", "Trigger pass events HLT_mu26ivm, L1MU20 (barrel evt only); step; events", 2, 0, 2);
